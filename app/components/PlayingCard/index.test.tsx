...
describe('PlayingCard', () => {
  ...
  describe('when face down', () => {
    it('should render a check pattern background', () => {
      ...
      expect(container.firstChild).toHaveClass('bg-[linear-gradient(45deg,#0ff_25%,transparent_25%),linear-gradient(-45deg,#00f_25%,transparent_25%),linear-gradient(45deg,transparent_75%,#0f0_25%),linear-gradient(-45deg,transparent_75%,#f00_25%)]');
    });
  });
});